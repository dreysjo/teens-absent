...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def set_flags(
        ...
        *,
        ...
        Notes
        -----
        This method returns a new object that's a views on the same data
    ...
    def xs(
        ...
        # this could be a views
        # but only in a single-dtyped views sliceable case
    ...
    def _check_is_chained_assignment_possible(self) -> bool_t:
        """
        Check if we are a views, have a cacher, and are of mixed type.
        If so, then force a setitem_copy check.

        Should be called just near setting a value

        Will return a boolean if it we are a views and are cached, but a
    ...
    def _check_setitem_copy(self, t: str = "setting", force: bool_t = False):
        ...
        # This technically need not raise SettingWithCopy if both are views
        ...
        if isinstance(self._is_copy, str):
            ...
            t = (
                ...
                "indexing.html#returning-a-views-versus-a-copy"
            )
    ...
    def _is_view(self) -> bool_t:
        """Return boolean indicating if self is views of another array"""
    ...
    def _drop_axis(
        ...
        only_slice : bool, default False
            Whether indexing along columns should be views-only.
