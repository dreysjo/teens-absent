...
# -----------------------------------------------------------------------------
# Copy/views behaviour for accessing underlying array of Series/DataFrame
...
def test_series_values(using_copy_on_write, method):
    ...
    if using_copy_on_write:
        # .values still gives a views but is read-only
...
def test_series_to_numpy(using_copy_on_write):
    ...
    arr = ser.to_numpy()
    if using_copy_on_write:
        # to_numpy still gives a views but is read-only
        assert np.shares_memory(arr, get_array(ser, "name"))
        assert arr.flags.writeable is False
