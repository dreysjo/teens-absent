...
class TestiLocBaseIndependent:
    ...
    def test_iloc_setitem_fullcol_categorical(self, indexer, key, using_array_manager):
        ...
        # check we dont have a views on cat (may be undesired GH#39986)
        df.iloc[0, 0] = "gamma"
        assert cat[0] != "gamma"
    ...
    def test_iloc_getitem_int_single_ea_block_view(self):
        ...
        # ser should be a *views* on the DataFrame data
        ser = df.iloc[2]

        # if we have a views, then changing arr[2] should also change ser[0]
