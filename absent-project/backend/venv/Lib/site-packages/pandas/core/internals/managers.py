...
class BaseBlockManager(DataManager):
    ...
    def is_view(self) -> bool:
        """return a boolean if we are a single block and are a views"""
        if len(self.blocks) == 1:
            return self.blocks[0].is_view

        # It is technically possible to figure out which blocks are views
        # e.g. [ b.values.base is not None for b in self.blocks ]
        # but then we have the case of possibly some blocks being a views
        # and some blocks not. setting in theory is possible on the non-views
    ...
    def copy(self, deep: bool | None | Literal["all"] = True) -> Self:
        ...
        # this preserves the notion of views copying of axes
        if deep:
...
class BlockManager(libinternals.BlockManager, BaseBlockManager):
    ...
    def fast_xs(self, loc: int) -> SingleBlockManager:
        ...
        if len(self.blocks) == 1:
            ...
            # in the case of a single block, the new block is a views
    ...
    def iget_values(self, i: int) -> ArrayLike:
        ...
        Warning! The returned array is a views but doesn't handle Copy-on-Write,
    ...
    def as_array(
        ...
        # TODO(CoW) handle case where resulting array is a views
...
class SingleBlockManager(BaseBlockManager, SingleDataManager):
    ...
    def get_rows_with_mask(self, indexer: npt.NDArray[np.bool_]) -> Self:
        ...
        # TODO(CoW) in theory only need to track reference if new_array is a views
