...
class MapAdapter:
    ...
    def dispatch(
        ...
        the endpoint and a dict with the values for the views.  It should
        look up the views function, call it, and return a response object
        ...
        :param view_func: a function that is called with the endpoint as
                          ...
                          to dispatch to the actual views function with this
