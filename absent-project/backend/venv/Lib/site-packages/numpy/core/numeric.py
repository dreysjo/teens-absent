...
def rollaxis(a, axis, start=0):
    ...
    -------
    res : ndarray
        For NumPy >= 1.10.0 a views of `a` is always returned. For earlier
        NumPy versions a views of `a` is returned only if the order of the
...
def moveaxis(a, source, destination):
    ...
    -------
    result : np.ndarray
        Array with moved axes. This array is a views of the input array.
