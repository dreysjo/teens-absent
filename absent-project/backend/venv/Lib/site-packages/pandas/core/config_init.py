...
pc_max_rows_doc = """
: int
    If max_rows is exceeded, switch to truncate views. Depending on
    `large_repr`, objects are either centrally truncated or printed as
    a summary views. 'None' value means unlimited.
...
pc_min_rows_doc = """
: int
    The numbers of rows to show in a truncated views (when `max_rows` is
...
pc_max_cols_doc = """
: int
    If max_cols is exceeded, switch to truncate views. Depending on
    `large_repr`, objects are either centrally truncated or printed as
    a summary views. 'None' value means unlimited.
...
: 'truncate'/'info'
    ...
    show a truncated table, or switch to the views from
...
copy_on_write_doc = """
: bool
    Use new copy-views behaviour using Copy-on-Write. Defaults to False,
