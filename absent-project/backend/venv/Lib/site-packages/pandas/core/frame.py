...
class DataFrame(NDFrame, OpsMixin):
    ...
    def _info_repr(self) -> bool:
        """
        True if the repr should show the info views.
        """
    ...
    def iterrows(self) -> Iterable[tuple[Hashable, Series]]:
        ...
        2. You should **never modify** something you are iterating over.
           ...
           data types, the iterator returns a copy and not a views, and writing
    ...
    def to_numpy(
        ...
        copy : bool, default False
            Whether to ensure that the returned value is not a views on
    ...
    def _getitem_nocopy(self, key: list):
        """
        Behaves like __getitem__, but returns a views in cases where __getitem__
        would make a copy.
        """
    ...
    def __getitem__(self, key):
        ...
        if is_hashable(key) and not is_iterator(key):
            ...
            # GH#45316 Return views if key is not duplicated
