...
def association_proxy(
    ...
    *,
    ...
    r"""Return a Python property implementing a views of a target
...
class AssociationProxy(
    ...
    """A descriptor that presents a read/write views of an object attribute."""
    ...
    def for_class(
        ...
        :attr:`_orm.Mapper.all_orm_descriptors`, and we want to views the
...
class AssociationProxyInstance(SQLORMOperations[_T]):
    ...
    :meth:`.AssociationProxy.for_class` method::
        ...
        # views if proxy object is scalar or not
        >>> proxy_state.scalar
        False
