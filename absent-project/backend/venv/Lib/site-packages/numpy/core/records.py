...
class recarray(ndarray):
    ...
    def __repr__(self):
        ...
        if self.dtype.type is record or not issubclass(self.dtype.type, nt.void):
            ...
            # otherwise represent it using np.array plus a views
            # This should only happen if the user is playing
            # strange games with dtypes.
            prefix = "array("
            fmt = 'array(%s,%sdtype=%s).views(numpy.recarray)'
...
def fromstring(datastring, dtype=None, shape=None, offset=0, formats=None,
    ...
    -------
    np.recarray
        Record array views into the data in datastring. This will be readonly
...
def array(obj, dtype=None, shape=None, offset=0, strides=None, formats=None,
    ...
    return ``obj.views(recarray)``, making a copy of the data if ``copy=True``.
