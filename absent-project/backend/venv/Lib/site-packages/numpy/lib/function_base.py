...
def flip(m, axis=None):
    ...
    -------
    out : array_like
        A views of `m` with the entries of axis reversed.  Since a views is
...
def gradient(f, *varargs, axis=None, edge_order=1):
    ...
    if otype.type is np.datetime64:
        ...
        # views as timedelta to allow addition
        f = f.view(otype)
...
def meshgrid(*xi, copy=True, sparse=False, indexing='xy'):
    ...
    sparse : bool, optional
        ...
        .. versionadded:: 1.7.0
    copy : bool, optional
        If False, a views into the original arrays are returned in order to
