...
class ExtensionArray:
    ...
    * _from_sequence_of_strings
    ...
    def to_numpy(
        ...
        copy : bool, default False
            Whether to ensure that the returned value is a not a views on
    ...
    def view(self, dtype: Dtype | None = None) -> ArrayLike:
        ...
        ExtensionArray or np.ndarray
            A views on the :class:`ExtensionArray`'s data.

        Examples
        --------
        This gives views on the underlying data of an ``ExtensionArray`` and is not a
        copy. Modifications on either the views or the original ``ExtensionArray``
        ...
        #   giving a views with the same dtype as self.
    ...
    def transpose(self, *axes: int) -> ExtensionArray:
        """
        Return a transposed views on this array.
    ...
    def ravel(self, order: Literal["C", "F", "A", "K"] | None = "C") -> ExtensionArray:
        """
        Return a flattened views on this array.
